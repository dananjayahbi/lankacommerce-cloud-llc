 ...
 * Route: `/cart`
 *
 * Fully client-side — no SSR needed since cart lives in localStorage.
 * Shows cart line items, quantity controls, and a checkout CTA.
 */
...
export default function CartPage() {
  ...
  // Use a fixed currency since we're client-side. The currency is available
  // from tenantData in the layout but not threaded here — LKR is the platform
  // default.
  const currency = "LKR";
