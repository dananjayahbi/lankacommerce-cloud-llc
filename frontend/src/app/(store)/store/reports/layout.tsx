...
const NAV_LINKS = [
  { label: 'Profit & Loss', href: '/store/reports/profit-loss' },
  { label: 'Sales by Product', href: '/store/reports/sales-by-product' },
  { label: 'Sales by Staff', href: '/store/reports/sales-by-staff' },
  { label: 'Revenue Trend', href: '/store/reports/revenue-trend' },
  { label: 'Inventory Valuation', href: '/store/reports/inventory-valuation' },
  { label: 'Stock Movements', href: '/store/reports/stock-movements' },
  { label: 'Customer Analytics', href: '/store/reports/customers' },
  { label: 'Staff Performance', href: '/store/reports/staff-performance' },
  { label: 'Returns', href: '/store/reports/returns' },
]
