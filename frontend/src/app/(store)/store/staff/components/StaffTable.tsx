            ...
            return (
              <TableRow key={member.id}>
                ...
                <TableCell className="text-right">
                  <Link href={`/store/staff/${member.id}`} className="inline-flex items-center justify-center rounded-lg px-2 py-1 text-sm font-medium hover:bg-muted transition-colors">
                    View
                  </Link>
                </TableCell>
              </TableRow>
