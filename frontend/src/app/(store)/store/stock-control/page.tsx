    ...
    <main className="min-h-screen bg-[#F1F5F9] p-6">
      ...
      <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {can(PERMISSIONS.STOCK_ADJUST) && (
          <ActionCard
            href="/store/stock-control/adjust"
        ...
        {can(PERMISSIONS.STOCK_VIEW) && (
          <ActionCard
            href="/store/stock-control/movements"
        ...
        {can(PERMISSIONS.STOCK_TAKE_MANAGE) && (
          <ActionCard
            href="/store/stock-control/stock-takes"
        ...
        {can(PERMISSIONS.PRODUCTS_VIEW_COST) && (
          <ActionCard
            href="/store/stock-control/valuation"
            icon={<BarChart2Icon className="size-5" />}
            title="Valuation"
      ...
      <div className="mt-6">
        ...
        <div className="mt-2 text-right">
          <Link href="/store/stock-control/movements" className="text-sm font-medium text-[#F97316] hover:underline">
            View All Movements →
          </Link>
        </div>
      </div>
